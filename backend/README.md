...
## Project Structure
    ...
    ├── testapiautoconnect_128013  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_128013`
...
2. Clone this repo and `cd testapiautoconnect_128013`
